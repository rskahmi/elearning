...
function modalEditNPPBaru (
    ...
    assignData("edtperihal", perihal);
    assignData("edtanggaran", anggaran);
    setForm("#form-editModal", action);
}
...
function modalEditKesejahteraan (
    action,
    judul,
    perihal,
    jenis,
...
function modalEditCourse(el){
    assignData("edtNama", el.dataset.nama);
    assignData("edtDeskripsi", el.dataset.deskripsi);
    setForm("#form-editModal", el.dataset.action);
}
