    ...
    <meta name="og:image" content="{{ asset('assets/img/logo/logogaruda.png') }}">
    ...
    <meta name="image" content="{{ asset('assets/img/logo/logogaruda.png') }}">
    <meta name="keywords" content="laundry">
    <meta name="author" content="{{ config('app.url') }}">

<title>{{ config('app.name') }} | @yield('title')</title>

<link rel="shortcut icon" href="{{ asset('assets/img/logo/logogaruda.png') }}" type="image/x-icon">
